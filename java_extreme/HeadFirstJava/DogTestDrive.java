class DogTestDrive {
    ...
    public static void main(String[] java) {
       ...
       // pets[1] = new Dog();
        ...
        //d.myPublicMethod();
        // d.specific = "d";//you can do this but not a OOP way
         //d2.nonSpecific = "d2"; 
        // d3.specific = "d3";
       //  System.out.println( d.specific );
         //System.out.println( d2.nonSpecific );
        ...
        // System.out.println( d4.getName() );//calling this class which is canine
         //d4.bark();//barkin canine
         //System.out.println( d4.name );//sine d4 is Canine but not this because Dog calls parent
         //System.out.println( d4.specific );
         //d4.bigTeeth(); //doesn't work because polymorphism you need also what parent has, Dog doesn't have bigTeeth
        ...
        // //because param is Dog
         ...
         //System.out.println( d6.breed );//if not in class looks at parent
